...
public class DigestUtils {
	...
	/**
	 * Reads through a byte array and returns the digest for the data. Provided for
	 * symmetry with other methods.
	 *
	 * @param messageDigest
	 ...
	 *                  Guide</a> for information about standard
	 *                  algorithm names.
	...
	/**
	 * Returns a <code>MessageDigest</code> for the given <code>algorithm</code> or
	 * a default if there is a problem
	 ...
	 *                             Reference Guide</a> for information about
	 *                             standard
	 *                             algorithm names.
	...
	/**
	 * Updates the given {@link MessageDigest} from a String (converted to bytes
	 * using UTF-8).
	 * <p>
