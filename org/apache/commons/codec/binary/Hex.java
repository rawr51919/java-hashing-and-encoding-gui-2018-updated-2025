...
public class Hex implements BinaryEncoder, BinaryDecoder {
	 ...
	 * returned array will be half the length of the passed String, as it takes two
	 * characters to represent any given
	 ...
	 * of bytes of those same values. The
	 * returned array will be half the length of the passed array, as it takes two
	 * characters to represent any given
	 ...
	 * two characters to represent any
	 * given byte.
	 *
	 * @param data
	 ...
	 *                    a byte[] to convert to Hex characters
	 * @param toLowerCase
	 *                    <code>true</code> converts to lowercase,
	...
	protected static char[] encodeHex(final byte[] data, final char[] toDigits) {
		...
		for (int i = 0; i < l; i++) {
			int d = data[i] & 0xFF;
			out[i * 2] = toDigits[(d >>> 4) & 0x0F];
			out[i * 2 + 1] = toDigits[d & 0x0F];
		}
		return out;
	}
	 ...
	 * of each byte in order. The returned
	 ...
	 * each byte in order. The returned
	 * String will be double the length of the passed array, as it takes two
	 * characters to represent any given byte.
	 *
	 * @param data
	 ...
	 * The returned array will be half the length of the passed array, as it takes
	 ...
	 * @throws DecoderException
	 *                          Thrown if an odd number of characters is supplied to
	 *                          this function
	 * @see #decodeHex(char[])
	 */
	@Override
	 ...
	 * values into an array of bytes of those
	 * same values. The returned array will be half the length of the passed String
	 * or array, as it takes two characters
	 * to represent any given byte. An exception is thrown if the passed char array
	 * has an odd number of elements.
	 *
	 * @param object
	 *               A String, ByteBuffer, byte[], or an array of character bytes
	...
	public Object decode(final Object object) throws DecoderException {
		return switch (object) {
			case String str -> decode(str.toCharArray());
			case byte[] bytes -> decode(bytes);
			case ByteBuffer buffer -> decode(buffer);
			case char[] chars -> decodeHex(chars);
			default -> throw new DecoderException("Unsupported object type: " + object.getClass());
		};
	}
	 ...
	 * byte in order. The returned array will be double the length of the passed
	 * array, as it takes two characters to
	 * represent any given byte.
	 * <p>
	 * The conversion from hexadecimal characters to the returned bytes is performed
	 * with the charset named by
	 * {@link #getCharset()}.
	 * </p>
	 *
	 * @param array
	 ...
	 * the hexadecimal values of each
	 * byte in order. The returned array will be double the length of the passed
	 * array, as it takes two characters to
	 * represent any given byte.
	 * <p>
	 ...
	 * representing the hexadecimal values of each
	 * byte in order. The returned array will be double the length of the passed
	 * String or array, as it takes two
	 * characters to represent any given byte.
	 * <p>
	...
	public Object encode(final Object object) throws EncoderException {
		final byte[] byteArray = switch (object) {
			case String str -> str.getBytes(this.getCharset());
			case ByteBuffer buffer -> buffer.array();
			case byte[] bytes -> bytes;
			default -> throw new EncoderException("Unsupported object type: " + object.getClass());
		};
