...
public abstract class BaseNCodec implements BinaryEncoder, BinaryDecoder {
	...
	static class Context {
		 ...
		 * every 4/8 reads when decoding. This
	 ...
	 * bPos, up to a maximum of bAvail
	 ...
	 * the Encoder interface, and will throw an EncoderException if the supplied
	 ...
	 * order to satisfy the requirements of
	 * the Decoder interface, and will throw a DecoderException if the supplied
	...
	public Object decode(final Object obj) throws DecoderException {
		return switch (obj) {
			case byte[] b -> decode(b);
			case String s -> decode(s);
			default -> throw new DecoderException("Parameter supplied to Base-N decode is not a byte[] or a String");
		};
	}
	 ...
	 *                   allowed
	 *
	 * @return <code>true</code> if all bytes are valid characters in the alphabet
	 ...
	 * @param arrayOctet
	 *                   byte array to test
	 * @return <code>true</code> if any byte is a valid character in the alphabet or
	 *         PAD; <code>false</code> otherwise
	 */
