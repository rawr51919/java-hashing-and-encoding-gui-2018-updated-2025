...
public class UUEncode {
	...
	public static byte[] encode(
		...
		try {
			...
			throw new UUEncodingException("exception encoding UUEncoded string: {0}", e);
		}
	...
	public static byte[] decode(
		...
		try {
			...
			throw new UUEncodingException("exception decoding UUEncoded string: {0}", e);
		}
	...
	/**
	 * decode the UUEncoded String data.
	 *
	 * @return a byte array representing the decoded data.
	 */
	public static byte[] decode(
	...
	/**
	 * decode the UUEncoded encoded String data writing it to the given output
	 * stream.
	 *
	 * @return the number of bytes produced.
	 */
